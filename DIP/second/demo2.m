...
labels2a=mySpectralClustering(Wa, k_vec(1));  %Clustering, k=2
labels3a=mySpectralClustering(Wa, k_vec(2));  %Clustering, k=3
labels4a=mySpectralClustering(Wa, k_vec(3));  %Clustering, k=4
...
%Getting the columns with the labels
labels2b=mySpectralClustering(Wb, k_vec(1));  %Clustering, k=2
labels3b=mySpectralClustering(Wb, k_vec(2));  %Clustering, k=3
labels4b=mySpectralClustering(Wb, k_vec(3));  %Clustering, k=4
%Finished getting the columns
...
figure("Name","Spectral Clustering Results")
