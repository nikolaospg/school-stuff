...
function [x_values, f_values, grad_values]=steepest_descent(f, gradf, x0, e, gamma_method, gamma_params)
    
    %Working with the arguments
    x0=x0(:);
    fprintf("Implementing Steepest descend on f, with x0=(%d,%d) and e=%d\n", x0(1), x0(2), e);
    ...
    while(n<1000)
        ...
        x_current=x_current-gamma*current_grad;     %Getting the next x value
        n=n+1;
