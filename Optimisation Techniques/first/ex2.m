...
%This script show the results from the golden_section
...
[a_vector1, b_vector1, k1, f_comp1] = golden_section(f1, a, b, l);
[a_vector2, b_vector2, k2, f_comp2] = golden_section(f2, a, b, l);
[a_vector3, b_vector3, k3, f_comp3] = golden_section(f3, a, b, l);
...
for i=1:length(varying_l)
    [~,~,~,f1_comps_l(i)]=golden_section(f1,a,b,varying_l(i));
    [~,~,~,f2_comps_l(i)]=golden_section(f2,a,b,varying_l(i));
    [~,~,~,f3_comps_l(i)]=golden_section(f3,a,b,varying_l(i));
end
...
for i=1:length(varying_l)
    [a1_vector_n, b1_vector_n, n1 ,~]=golden_section(f1,a,b,varying_l(i));
    [a2_vector_n, b2_vector_n, n2 ,~]=golden_section(f2,a,b,varying_l(i));
    [a3_vector_n, b3_vector_n, n3 ,~]=golden_section(f3,a,b,varying_l(i));
